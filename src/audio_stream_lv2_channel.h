#ifndef AUDIO_STREAM_LV2_CHANNEL_H
#define AUDIO_STREAM_LV2_CHANNEL_H
...
class AudioStreamLv2Channel : public AudioStream {
    GDCLASS(AudioStreamLv2Channel, AudioStream)

private:
    friend class AudioStreamPlaybackLv2Channel;
