#ifndef EDITOR_AUDIO_METER_NOTCHES_LV2_H
#define EDITOR_AUDIO_METER_NOTCHES_LV2_H
...
class EditorAudioMeterNotchesLv2 : public Control {
    GDCLASS(EditorAudioMeterNotchesLv2, Control);
...
private:
    struct AudioNotch {
        ...
        _FORCE_INLINE_ void operator=(const EditorAudioMeterNotchesLv2::AudioNotch &n) {
            relative_position = n.relative_position;
            db_value = n.db_value;
            render_db_value = n.render_db_value;
        }
