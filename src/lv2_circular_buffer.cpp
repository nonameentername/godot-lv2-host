...
template <typename T>
void Lv2CircularBuffer<T>::set_read_index(int p_index) {
    audio_buffer->read_index = p_index;
}

template <typename T>
void Lv2CircularBuffer<T>::set_write_index(int p_index) {
    audio_buffer->write_index = p_index;
}

template <typename T>
int Lv2CircularBuffer<T>::update_read_index(int p_frames) {
    const int read_index  = audio_buffer->read_index;
    const int write_index = audio_buffer->write_index;
