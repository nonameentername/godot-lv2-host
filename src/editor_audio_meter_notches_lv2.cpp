...
EditorAudioMeterNotchesLv2::EditorAudioMeterNotchesLv2() {
...
float EditorAudioMeterNotchesLv2::_scaled_db_to_normalized_volume(float db) {
...
void EditorAudioMeterNotchesLv2::add_notch(float p_normalized_offset, float p_db_value, bool p_render_value) {
    notches.push_back(AudioNotch(p_normalized_offset, p_db_value, p_render_value));
}

Vector2 EditorAudioMeterNotchesLv2::_get_minimum_size() const {
...
void EditorAudioMeterNotchesLv2::_update_theme_item_cache() {
...
void EditorAudioMeterNotchesLv2::set_editor_scale(float p_editor_scale) {
    editor_scale = p_editor_scale;
}

float EditorAudioMeterNotchesLv2::get_editor_scale() {
    return editor_scale;
}

void EditorAudioMeterNotchesLv2::_notification(int p_what) {
    switch (p_what) {
...
void EditorAudioMeterNotchesLv2::_bind_methods() {
    ClassDB::bind_method(D_METHOD("add_notch"), &EditorAudioMeterNotchesLv2::add_notch);
